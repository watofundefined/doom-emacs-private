...
;; (org-level-4 ((t (,@fg-base0 ,@bg-base03))))
;; (org-level-5 ((t (,@fg-base0 ,@bg-base03))))
;; (org-level-6 ((t (,@fg-base0 ,@bg-base03))))
;; (org-level-7 ((t (,@fg-base0 ,@bg-base03))))
;; (org-level-8 ((t (,@fg-base0 ,@bg-base03))))
               ...
               (let ((back base03))
                 ...
                 (let ((bg-back   `(:background ,back))
                   ...
                   `((;; basic
                      ...
                      ;; wat: original (org-todo ((t (,@fmt-bold ,@fg-base03 ,@bg-red))))
                      (org-todo ((t (,@fmt-bold ,@fg-red))))
                      ...
                      ;; wat - added level styling for the even greyness
                      (org-level-1 ((t (,@fg-base0 ,@bg-base03))))
                      (org-level-2 ((t (,@fg-base0 ,@bg-base03))))
                      (org-level-3 ((t (,@fg-base0 ,@bg-base03))))
                      (org-level-4 ((t (,@fg-base0 ,@bg-base03))))
